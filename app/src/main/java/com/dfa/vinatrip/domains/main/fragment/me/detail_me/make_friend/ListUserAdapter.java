...
public class ListUserAdapter extends RecyclerView.Adapter<ListUserAdapter.ProfileViewHolder> {
    ...
    public void onBindViewHolder(final ProfileViewHolder holder, int position) {
        ...
        holder.tvNickname.setText(userProfile.getUsername());
        ...
        // If one userProfile is in userList of current user login
//        for (int j = 0; j < userList.size(); j++) {
//            if (userProfile.getId().equals(userList.get(j).getFriendId())) {
//                switch (userList.get(j).getState()) {
//                    case "requested":
