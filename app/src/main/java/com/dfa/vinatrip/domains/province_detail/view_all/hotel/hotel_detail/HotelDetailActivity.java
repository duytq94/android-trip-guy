...
public class HotelDetailActivity extends BaseActivity<HotelDetailView, HotelDetailPresenter>
    ...
    @ViewById(R.id.activity_hotel_detail_iv_feedback_more)
    ...
    void init() {
        ...
        feedbackAdapter = new RecyclerHotelFeedbackAdapter(this, feedbackResponsesTerm);
    ...
    @Click(R.id.activity_hotel_detail_iv_feedback_more)
